...
class Data(object):
    def __init__(self, args):
        ...
        trainset = PigUSPS(root=args.data_dir, train=True, download=True, transform=transform)
        ...
        testset = PigUSPS(root=args.data_dir, train=False, download=True, transform=transform)
